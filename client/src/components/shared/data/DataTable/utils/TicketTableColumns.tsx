...
export const VARIANT_COLUMN_VISIBILITY: Record<TicketTableVariant, Record<string, boolean>> = {
  queue: {
    searchField: false, description: false,
    facility: false, raised_by: false, created_at: false,
    due_date: false, sla_countdown: false,
  },
  compact: {
    searchField: false, description: false,
    ticket_no: false, facility: false, sectionName: false,
    raised_by: false, assigned_to: false, created_at: false,
    due_date: false, sla_countdown: false, rate_actions: false,
  },
  sla: {
    searchField: false, description: false,
    facility: false, raised_by: false, created_at: false,
    priority: false, rate_actions: false,
    due_date: false,
  },
  admin: {
    searchField: false, description: false,
    facility: false, created_at: false, sla_countdown: false,
  },
  'my-tickets': {
    searchField: false,
    facility: false, raised_by: false,
    due_date: false, sla_countdown: false, actions: false,
  },
};
