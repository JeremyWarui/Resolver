...
export type SectionHeadSection = 'dashboard' | 'tickets' | 'technicians' | 'reports' | 'settings';

interface SideBarProps {
  activeSection: SectionHeadSection;
  onSectionChange: (id: SectionHeadSection) => void;
}

const SectionHeadSideBar = ({ activeSection, onSectionChange }: SideBarProps) => {
    ...
    <>
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-xs text-gray-500 mt-1">Section Head Portal</p>
        </div>
...
export default SectionHeadSideBar;
